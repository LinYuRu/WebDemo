...
-->		
    ...
    <li><a href="seller/productlist"> 所有產品 </a> <span class="divider">/</span></li>
    <li class="active"><a href="addProduct"> 新增商品 </a></li>
    </ul>	
	...
	<div class="row-fluid">
			...
			<div id="myCarousel" class="carousel slide cntr">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="#"> <img src="${pageContext.request.contextPath}/img/a.jpg" alt="" style="width:100%"></a>
                  </div>
			...
			<div class="span7">
				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>${seller.sellerName}</span></label>
					<div class="controls">
            ...
            <ul id="productDetail" class="nav nav-tabs">
              <li class="active"><a href="#home" data-toggle="tab">賣家資訊</a></li>
              <li class=""><a href="#profile" data-toggle="tab">所有商品 </a></li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">分類 <b class="caret"></b></a>
