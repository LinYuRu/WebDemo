...
public class GlobalService {
		...
		public static final String SYSTEM_NAME = "ShoppingMall";
		public static final int IMAGE_FILENAME_LENGTH = 20;
		public static final String JNDI_DB_NAME = "java:comp/env/jdbc/BookDataSQLver";
		public static final String KEY ="Alex@gmail.com"; // 16, 24, 32
...
//			${SYSTEM.systemName}
	...
	MessageDigest.getInstance("MD5");
		...
		/**
		 * 依MD5演算法將檔案file轉換為128位元(16個位元組

	)的資料。
		 * 
		 * @param message
		 *            : 要加密的字串
		 * @return : 128位元資料的16進位表示法所構成的字

	串
		 */
		public static String getMD5Endocing(File file) throws 
...
//				int value = (b & 0x7F) + (b < 0 ? 128 : 0);
	...
	// 將上傳的欄位資料寫入到location屬性所指定的資料夾，檔名為"part_"+ name
		...
		/**
		 * 本方法可對加密之字串(Ciphertext)解密，key為當初

	加密時的金鑰 傳回值為解密後的字串(Plaintext)
		 * 
		 */
		public static String decryptString(String key, String 
				stringToDecrypt) {
