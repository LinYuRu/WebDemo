...
<div class="well well-small">
	...
	<c:forEach var='sellerProduct' items='${sellerProduct}'>
	  	<div class="row-fluid">
<!-- 	  	<div class="span2"> -->
<%-- 			<a href="<spring:url value='product?productId=${sellerProduct.productId}' />"> --%>
<%-- 			<img src="<c:url value='/getPicture/${sellerProduct.productId}'/>" alt=""></a> --%>
<!-- 		</div> -->
		<div class="span6">
			<h5>${sellerProduct.productName} </h5>
			<p>
			${sellerProduct.productInfo}
			</p>
		</div>
		<div class="span4 alignR">
		<form class="form-horizontal qtyFrm">
		<h3>$ ${sellerProduct.productPrice}</h3>
		<h4> ${sellerProduct.categoryDefualt} </h4>
		<label class="checkbox">
			<input type="checkbox">  加入清單
		</label><br>
<!-- 		<div class="btn-group"> -->
<!-- 		  <a href="#" class="defaultBtn"><span class=" icon-shopping-cart"></span> 加入購物車</a> -->
<%-- 		  <a href="<spring:url value='product?productId=${sellerProduct.productId}' />" class="shopBtn">VIEW</a> --%>
<!-- 		 </div> -->
			</form>
		</div>
