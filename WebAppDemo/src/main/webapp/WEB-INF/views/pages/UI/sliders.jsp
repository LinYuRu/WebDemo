...
<html>
  <head>
    ...
    <!-- Ion Slider -->
    <link href="${pageContext.request.contextPath}/plugins/ionslider/ion.rangeSlider.css" rel="stylesheet" type="text/css" />
    <!-- ion slider Nice -->
    <link href="${pageContext.request.contextPath}/plugins/ionslider/ion.rangeSlider.skinNice.css" rel="stylesheet" type="text/css" />
    <!-- bootstrap slider -->
    <link href="${pageContext.request.contextPath}/plugins/bootstrap-slider/slider.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
  ...
  <body class="skin-blue">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/pages/UI/sliders"><i class="fa fa-circle-o"></i> Sliders</a></li>
    ...
    <!-- Ion Slider -->
    <script src="${pageContext.request.contextPath}/plugins/ionslider/ion.rangeSlider.min.js" type="text/javascript"></script>

    <!-- Bootstrap slider -->
    <script src="${pageContext.request.contextPath}/plugins/bootstrapslider/bootstrapslider.js" type="text/javascript"></script>
