			...
			<div id="myCarousel" class="carousel slide cntr">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="#"> <img src="<c:url value='/getPicture/${product.productId}'/>" alt="" style="width:100%"></a>
                  </div>
                  <div class="item">
                     <a href="#"> <img src="<c:url value='/getPicture/${product.productId}'/>" alt="" style="width:100%"></a>
                  </div>
			...
			<div class="span7">
				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>$ ${product.productPrice}</span></label>
					<div class="controls">
					<input type="number" class="span6" placeholder="Qty.">
					</div>
				  </div>
<!-- 				  <h4> 數量 </h4> -->
<%-- 				  <p>還剩 ${product.productQuantity} 件 --%>
<!-- 				  </p><br> -->
