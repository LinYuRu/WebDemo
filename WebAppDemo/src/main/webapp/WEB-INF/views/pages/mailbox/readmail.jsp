          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="${pageContext.request.contextPath}/pages/mailbox/compose">Compose</a></li>
                <li class="active"><a href="${pageContext.request.contextPath}/pages/mailbox/readmail">Read</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
