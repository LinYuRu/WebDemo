	...
	<div class="topNav">
		<div class="container">
			<div class="alignR">
				...
				<a class="active" href="cart.jsp"><span class="icon-shopping-cart"></span> 2 Item(s) - <span class="badge badge-warning"> $448.42</span></a>
			</div>
		</div>
	</div>
</div>
		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  ...
			  <li class=""><a href="three-col.jsp">Three Column</a></li>
